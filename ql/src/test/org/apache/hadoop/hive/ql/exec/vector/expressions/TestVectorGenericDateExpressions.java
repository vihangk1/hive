...
public class TestVectorGenericDateExpressions {
  ...
  private void validateDateAdd(VectorizedRowBatch batch, PrimitiveCategory colType1, long scalar2,
    ...
    udf.setInputTypeInfos(new TypeInfo[] {primitiveCategoryToTypeInfo(colType1), TypeInfoUtils.voidTypeInfo});
    udf.transientInit();
    udf.evaluate(batch);
  ...
  public void testDateAddColScalar() throws HiveException {
    ...
    udf.setInputTypeInfos(new TypeInfo[] { TypeInfoUtils.stringTypeInfo, TypeInfoUtils.timestampTypeInfo});
    udf.transientInit();
  ...
  public void testDateDiffScalarCol() throws HiveException {
    ...
    udf.setInputTypeInfos(new TypeInfo[] { TypeInfoUtils.timestampTypeInfo, TypeInfoUtils.stringTypeInfo});
    udf.transientInit();
    batch.cols[0] = new BytesColumnVector(1);
    batch.cols[1] = new LongColumnVector(1);
