            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.errors = new ArrayList<String>(_list1064.size);
                String _elem1065;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.warnings = new ArrayList<String>(_list1067.size);
                String _elem1068;
      ...
      if (struct.errors != null) {
        if (struct.isSetErrors()) {
          oprot.writeFieldBegin(ERRORS_FIELD_DESC);
          {
            ...
            for (String _iter1070 : struct.errors)
            {
      ...
      if (struct.warnings != null) {
        if (struct.isSetWarnings()) {
          oprot.writeFieldBegin(WARNINGS_FIELD_DESC);
          {
            ...
            for (String _iter1071 : struct.warnings)
            {
      ...
      if (struct.isSetErrors()) {
        {
          ...
          for (String _iter1072 : struct.errors)
          {
      ...
      if (struct.isSetWarnings()) {
        {
          ...
          for (String _iter1073 : struct.warnings)
          {
