            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.filters = new ArrayList<String>(_list1184.size);
                String _elem1185;
      ...
      if (struct.filters != null) {
        if (struct.isSetFilters()) {
          oprot.writeFieldBegin(FILTERS_FIELD_DESC);
          {
            ...
            for (String _iter1187 : struct.filters)
            {
      ...
      if (struct.isSetFilters()) {
        {
          ...
          for (String _iter1188 : struct.filters)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.filters = new ArrayList<String>(_list1189.size);
          String _elem1190;
