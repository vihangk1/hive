...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class GetPartitionsRequest implements org.apache.thrift.TBase<GetPartitionsRequest, GetPartitionsRequest._Fields>, java.io.Serializable, Cloneable, Comparable<GetPartitionsRequest> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.groupNames = new ArrayList<String>(_list1208.size);
                String _elem1209;
                for (int _i1210 = 0; _i1210 < _list1208.size; ++_i1210)
                {
                  _elem1209 = iprot.readString();
                  struct.groupNames.add(_elem1209);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.processorCapabilities = new ArrayList<String>(_list1211.size);
                String _elem1212;
      ...
      if (struct.groupNames != null) {
        if (struct.isSetGroupNames()) {
          oprot.writeFieldBegin(GROUP_NAMES_FIELD_DESC);
          {
            ...
            for (String _iter1214 : struct.groupNames)
            {
      ...
      if (struct.processorCapabilities != null) {
        if (struct.isSetProcessorCapabilities()) {
          oprot.writeFieldBegin(PROCESSOR_CAPABILITIES_FIELD_DESC);
          {
            ...
            for (String _iter1215 : struct.processorCapabilities)
            {
  ...
  private static class GetPartitionsRequestTupleScheme extends TupleScheme<GetPartitionsRequest> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, GetPartitionsRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TList _list1218 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, iprot.readI32());
          struct.groupNames = new ArrayList<String>(_list1218.size);
          String _elem1219;
          for (int _i1220 = 0; _i1220 < _list1218.size; ++_i1220)
          {
            _elem1219 = iprot.readString();
            struct.groupNames.add(_elem1219);
          }
        }
        struct.setGroupNamesIsSet(true);
      }
